document.addEventListener('DOMContentLoaded', () => {
  ...
  const steps = [
    ...
    {
      speech: "Para calcular el área total, aplicamos la fórmula: largo × ancho. Entonces, 12m × 8m = 96m². Hagan clic en el área para ver el cálculo.",
    ...
    {
      speech: "Si el área total es 96m², para encontrar un cuarto realizamos: 96m² ÷ 4 = 24m². Hagan clic en las diferentes partes para ver sus áreas.",
      action: () => showFinalCalculation(),
      interactive: true
    },
    {
      speech: "¡Excelente! El área para sembrar maíz es 24m². La respuesta correcta es la opción a). ¡Han hecho un gran trabajo!",
  ...
  function updateStep(step) {
    ...
    // Ensure math is rendered after content updates
  ...
  function showAreaCalculation() {
    const farm = `
      ...
      <text x="200" y="150" text-anchor="middle" fill="#1a202c" class="fade-in clickable" data-info="Área Total: 96m2" font-weight="600">Área Total: 96 m2</text>
      <foreignObject x="100" y="170" width="200" height="30">
        <div xmlns="http://www.w3.org/1999/xhtml" style="text-align: center;">
          \\(12\\,\\text{m} \\times 8\\,\\text{m} = 96\\,\\text{m}^2\\)
        </div>
      </foreignObject>
    `;
    farmSvg.innerHTML = farm;
    renderMathInElement(farmSvg);
  }
  ...
  function showFraction() {
    const farm = `
      ...
      />
      <text x="125" y="100" text-anchor="middle" fill="#1a202c" class="fade-in" font-weight="600">1/4 del área</text>
    `;
    farmSvg.innerHTML = farm;
  }
  ...
  function showFinalCalculation() {
    const farm = `
      ${createFarmPattern()}
      ${createAnimatedRect(50, 50, 300, 200, 'url(#grass)', '#2f855a')}
      <rect x="50" y="50" width="150" height="100" fill="url(#crops)" stroke="#2f855a" stroke-width="2" class="fade-in draggable"/>
      <foreignObject x="100" y="140" width="200" height="30">
        <div xmlns="http://www.w3.org/1999/xhtml" style="text-align: center;">
          \\(96\\,\\text{m}^2 \\div 4 = 24\\,\\text{m}^2\\)
        </div>
      </foreignObject>
    `;
    farmSvg.innerHTML = farm;
  ...
  function highlightAnswer() {
    const farm = `
      ${createFarmPattern()}
      ${createAnimatedRect(50, 50, 300, 200, 'url(#grass)', '#2f855a')}
      <rect x="50" y="50" width="150" height="100" fill="url(#crops)" stroke="#2f855a" stroke-width="2" class="fade-in"/>
      <foreignObject x="100" y="120" width="200" height="30">
        <div xmlns="http://www.w3.org/1999/xhtml" style="text-align: center;">
          \\(24\\,\\text{m}^2\\)
        </div>
      </foreignObject>
      <text x="200" y="170" text-anchor="middle" fill="#1a202c" class="fade-in clickable" data-info="¡Respuesta correcta!">¡Respuesta correcta!</text>
    `;
    farmSvg.innerHTML = farm;
    renderMathInElement(farmSvg);
  }
